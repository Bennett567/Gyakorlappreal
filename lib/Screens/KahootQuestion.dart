...
class _KahootQuestionState extends State<KahootQuestion> {
  ...
  void initState() {
    super.initState();
    wrongAns1 =
        SimpleInputBox('Rossz válasz', 150, 150, Colors.blue, wrongController1);
    wrongAns2 = SimpleInputBox(
        'Rossz válasz', 150, 150, Colors.yellowAccent, wrongController2);
    wrongAns3 = SimpleInputBox(
        'Rossz válasz', 150, 150, Colors.green, wrongController3);
    correctAns = SimpleInputBox(
        'Jó Választ IDE!', 150, 150, Colors.red, correctController);
  }
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          Align(
                              alignment: Alignment.topLeft, child: correctAns),
                          Align(alignment: Alignment.topRight, child: wrongAns1)
                        ],
                      ),
                      Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
